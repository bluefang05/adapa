...
<div class="container">
    ...
    <section class="page-hero content-hero mb-4">
        ...
        <div class="compact-meta-row">
            ...
            <span class="soft-badge"><i class="bi bi-collection"></i> Bloques reutilizables</span>
        </div>
    </section>
                            ...
                            <details class="panel page-assist-card mb-3">
                                <summary class="page-assist-summary">
                                    <div>
                                        ...
                                        <div class="fw-semibold mt-1">Atajos para ajustar bloques sin perder el hilo</div>
                                        <div class="small text-muted mt-1">Abre esta seccion si necesitas regenerar, revisar checklist o traer media desde biblioteca.</div>
                                    </div>
                                ...
                                <div class="panel-body pt-0 page-assist-body">
                                    ...
                                    <div class="alert context-note mt-3 mb-0">
                                        <div class="fw-semibold mb-2">Checklist rapido antes de actualizar</div>
