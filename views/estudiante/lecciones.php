                        ...
                        <article class="surface-card lesson-path-card h-100">
                            <div class="card-body lesson-path-body">
                                <div class="lesson-path-head">
                                    ...
                                    <div class="lesson-path-progress">
                                        <span class="lesson-path-progress-value"><?php echo (int) ($leccion->porcentaje_completado ?? 0); ?>%</span>
                                        <span class="lesson-path-progress-copy">completado</span>
                                    </div>
                                </div>
