    ...
    <section class="page-hero mb-4">
        ...
        <div class="metric-grid">
            <div class="metric-card">
                ...
                <div class="metric-value"><?php echo (int) ($ticketSummary->nuevos ?? 0); ?></div>
                <div class="metric-note">Pendientes de primera revision.</div>
            </div>
            <div class="metric-card">
                <div class="metric-label">En revision</div>
                <div class="metric-value"><?php echo (int) ($ticketSummary->en_revision ?? 0); ?></div>
                <div class="metric-note">Casos que ya estan siendo atendidos.</div>
            </div>
            <div class="metric-card">
                <div class="metric-label">Audio/Video</div>
                <div class="metric-value"><?php echo (int) ($ticketSummary->audio_video ?? 0); ?></div>
                <div class="metric-note">Incidencias ligadas a multimedia.</div>
            </div>
            <div class="metric-card">
                <div class="metric-label">Contenido</div>
                <div class="metric-value"><?php echo (int) ($ticketSummary->contenido ?? 0); ?></div>
                <div class="metric-note">Errores de copy, teoria o consignas.</div>
            </div>
            <div class="metric-card">
                <div class="metric-label">Alta prioridad</div>
                <div class="metric-value"><?php echo (int) ($ticketPrioritySummary->alta ?? 0); ?></div>
                <div class="metric-note">Dentro del resultado visible actual.</div>
            </div>
        </div>
    </section>
                        ...
                        <article class="surface-card h-100">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-start gap-3 flex-wrap mb-3">
                                    <div>
                                        ...
                                        <div class="small text-muted">
                                            <?php echo htmlspecialchars(trim(($ticket->nombre ?? '') . ' ' . ($ticket->apellido ?? ''))); ?> &middot; <?php echo htmlspecialchars(adminTicketRoleLabel($ticket)); ?>
                                        </div>
                                    </div>
                                ...
                                <div class="responsive-actions">
                                    <form method="POST" action="<?php echo url('/admin/tickets/status/' . $ticket->id); ?>" class="d-flex gap-2 flex-wrap">
                                        <?php echo csrf_input(); ?>
                                        <input type="hidden" name="return_to" value="<?php echo htmlspecialchars($currentTicketsUrl); ?>">
