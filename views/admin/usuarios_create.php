                    ...
                    <form action="<?php echo url('/admin/usuarios/create'); ?>" method="POST" class="row g-3">
                        ...
                        <div class="col-md-6">
                            <div class="form-check mt-md-4">
                                ...
                                <label class="form-check-label" for="activo">Cuenta activa desde el inicio</label>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-check mt-md-4">
                                ...
                                <label class="form-check-label" for="email_verificado">Marcar correo como verificado</label>
                            </div>
                        </div>
